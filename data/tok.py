...
inpf1 = codecs.open('english.10000', 'r','utf-8')
outf1 = codecs.open('english.10000.tok','w','utf-8')
inpf2 = codecs.open('turkish.10000', 'r','utf-8')
outf2 = codecs.open('turkish.10000.tok','w','utf-8')
max_len = 100

...
inpf1 = codecs.open('english.all', 'r','utf-8')
outf1 = codecs.open('english.all.tok','w','utf-8')
inpf2 = codecs.open('arabic.all', 'r','utf-8')
outf2 = codecs.open('arabic.all.tok','w','utf-8')
max_len = 10000
